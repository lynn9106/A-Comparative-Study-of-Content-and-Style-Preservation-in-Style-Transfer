    ...
    def run(self, vgg_weights, alpha=0.9, style_loss_weights=(1, 1, 1, 1, 1), epsilon=0.0001, max_iter=500):
        ...
        while iteration < max_iter:
            ...
            if abs(moving_loss - new_loss) <= epsilon:
                ...
                break
            print(iteration)
            print(torch.cuda.memory_allocated())  # 查看当前分配的内存量
            print(torch.cuda.memory_cached())     # 查看当前缓存的内存量
...
if __name__ == "__main__":
    ...
    parser.add_argument('--c_img', type=str, default='./data/content/05.jpg', help='Path to content image')
    parser.add_argument('--s_img', type=str, default='./data/style/05.jpg', help='Path to style image')
    ...
    if False:
        ...
        saveName = os.path.splitext(os.path.basename(args.c_img))[0] + '-' + os.path.splitext(os.path.basename(args.s_img))[0] + "_alpha=0.9.png"
