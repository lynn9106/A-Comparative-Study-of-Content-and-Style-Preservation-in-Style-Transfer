...
parser.add_argument('--org', type=str, default='images/content/richter_portrait.jpg')
parser.add_argument('--target', type=str, default='output/richter_portrait-richter2.png')
